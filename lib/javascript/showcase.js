...
var Showcase = new Class({
    ...
    // $each(this.options,function(v,k){this.options[k] = $(v);}.bind(this));
		this.container = $(el);
    ...
    screenNav.adopt(new Element("a",{"html": "&lt; previous","href":"#","events": {"click": this.previous.bindWithEvent(this)}}));
    this.screenPages = new Element("span", {"id": "screen-pages"});
    screenNav.adopt(this.screenPages);
    screenNav.adopt(new Element("a",{"html": "next &gt;","href":"#","events": {"click": this.next.bindWithEvent(this)}}));    
